...
public class Monom implements function {
	...
	public static final Comparator<Monom> _Comp = new Ex1.Monom_Comperator();
	 ...
	 * @param str is a String the method <Monom requested to build
	 */
